...
model{
  ...
  for(t in 1:n){
    for (site in 1:n_site){
        y[t,site] ~ dnorm(x[t,site],tau_obs[t,site])
  ...
  for(site in 1:n_site){
    ...
    for(t in 1:n){
       tau_obs[t,site] ~ dgamma(a_obs,r_obs)
    }
...
# --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- 
# 6. Add Tau_add and Tau_obs each per site ----------------------------------
# --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- 
...
# --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- 
# 7. Add Taus per site and FORECAST  ----------------------------------
# --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- 
...
# --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- 
# 8. Forecast and add month effect  ----------------------------------
# --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- 
