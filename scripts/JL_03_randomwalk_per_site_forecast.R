...
# --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- 
# Add Taus per site and FORECAST  ----------------------------------
# --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- 

# in this attempt, I'll model sites individually with a vector of tau_add
# and tau_obs per site, and trim the last year of data to practice forecasting
